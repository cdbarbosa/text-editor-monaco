...
},{}],"node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-languageserver-textdocument/lib/esm/main.js":[function(require,module,exports) {
/* --------------------------------------------------------------------------------------------
 * Copyright (c) Microsoft Corporation. All rights reserved.
 * Licensed under the MIT License. See License.txt in the project root for license information.
 * ------------------------------------------------------------------------------------------ */
...
Object.defineProperty(exports, "TextDocument", {
  enumerable: true,
  get: function () {
    return _main2.TextDocument;
  }
});
exports.ClientCapabilities = exports.ErrorCode = void 0;
...
var _main2 = require("./../vscode-languageserver-textdocument/lib/esm/main.js");
...
},{"./../vscode-languageserver-types/main.js":"node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-languageserver-types/main.js","./../vscode-languageserver-textdocument/lib/esm/main.js":"node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-languageserver-textdocument/lib/esm/main.js"}],"node_modules/monaco-editor/esm/vs/language/json/fillers/vscode-nls.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/parser/jsonParser.js":[function(require,module,exports) {
"use strict";
  ...
  JSONDocument.prototype.validate = function (textDocument, schema) {
    if (this.root && schema) {
      ...
      return validationResult.problems.map(function (p) {
        ...
        return _jsonLanguageTypes.Diagnostic.create(range, p.message, p.severity, p.code);
      });
    }
...
function validate(node, schema, validationResult, matchingSchemas) {
  ...
  function _validateNode() {
    ...
    if ((0, _objects.isDefined)(schema.const)) {
      ...
      if (!(0, _objects.equals)(val, schema.const)) {
        validationResult.problems.push({
          location: {
            offset: node.offset,
            length: node.length
  ...
  function _validateStringNode(node, schema, validationResult, matchingSchemas) {
    if ((0, _objects.isNumber)(schema.minLength) && node.value.length < schema.minLength) {
      validationResult.problems.push({
        location: {
          offset: node.offset,
          length: node.length
    ...
    if ((0, _objects.isNumber)(schema.maxLength) && node.value.length > schema.maxLength) {
      validationResult.problems.push({
        location: {
          offset: node.offset,
          length: node.length
...
function parse(textDocument, config) {
  ...
  function _errorAtRange(message, code, startOffset, endOffset, severity) {
    if (severity === void 0) {
      severity = _jsonLanguageTypes.DiagnosticSeverity.Error;
    }
  ...
  function _parseProperty(parent, keysSeen) {
    ...
    if (seen) {
      _errorAtRange(localize('DuplicateKeyWarning', "Duplicate object key"), _jsonLanguageTypes.ErrorCode.DuplicateKey, node.keyNode.offset, node.keyNode.offset + node.keyNode.length, _jsonLanguageTypes.DiagnosticSeverity.Warning);

      if (typeof seen === 'object') {
        _errorAtRange(localize('DuplicateKeyWarning', "Duplicate object key"), _jsonLanguageTypes.ErrorCode.DuplicateKey, seen.keyNode.offset, seen.keyNode.offset + seen.keyNode.length, _jsonLanguageTypes.DiagnosticSeverity.Warning);
      }
...
function () {
      ...
      if (node && node.type === 'object') {
        ...
        properties.forEach(function (p) {
          if (!currentProperty || currentProperty !== p) {
            proposed[p.keyNode.value] = _jsonLanguageTypes.CompletionItem.create('__');
          }
        });
  ...
  JSONCompletion.prototype.doesSupportMarkdown = function () {
    if (!(0, _objects.isDefined)(this.supportsMarkdown)) {
      ...
      this.supportsMarkdown = completion && completion.completionItem && Array.isArray(completion.completionItem.documentationFormat) && completion.completionItem.documentationFormat.indexOf(_jsonLanguageTypes.MarkupKind.Markdown) !== -1;
    }
...
},{"../parser/jsonParser.js":"node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/parser/jsonParser.js","../jsonLanguageTypes.js":"node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/jsonLanguageTypes.js"}],"node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-uri/index.js":[function(require,module,exports) {
...
},{"process":"../../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/services/jsonSchemaService.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  JSONSchemaService.prototype.getRegisteredSchemaIds = function (filter) {
    return Object.keys(this.registeredSchemasIds).filter(function (id) {
      var scheme = _index.URI.parse(id).scheme;
  ...
  JSONSchemaService.prototype.normalizeId = function (id) {
    ...
    try {
      return _index.URI.parse(id).toString();
    } catch (e) {
      return id;
    }
  };
...
var _jsonSchemaService = require("./jsonSchemaService.js");
...
function () {
  ...
  JSONValidation.prototype.configure = function (raw) {
    if (raw) {
      ...
      this.commentSeverity = raw.allowComments ? void 0 : _jsonLanguageTypes.DiagnosticSeverity.Error;
    }
  };
  ...
  JSONValidation.prototype.doValidation = function (textDocument, jsonDocument, documentSettings, schema) {
    ...
    var getDiagnostics = function (schema) {
      var trailingCommaSeverity = documentSettings ? toDiagnosticSeverity(documentSettings.trailingCommas) : _jsonLanguageTypes.DiagnosticSeverity.Error;
      ...
      if (schema) {
        if (schema.errors.length && jsonDocument.root) {
          ...
          if (property && property.keyNode.value === '$schema') {
            ...
            addProblem(_jsonLanguageTypes.Diagnostic.create(range, schema.errors[0], _jsonLanguageTypes.DiagnosticSeverity.Warning, _jsonLanguageTypes.ErrorCode.SchemaResolveError));
          } else {
            var range = _jsonLanguageTypes.Range.create(textDocument.positionAt(astRoot.offset), textDocument.positionAt(astRoot.offset + 1));
      ...
      if (typeof commentSeverity === 'number') {
        ...
        jsonDocument.comments.forEach(function (c) {
          addProblem(_jsonLanguageTypes.Diagnostic.create(c, message_1, commentSeverity, _jsonLanguageTypes.ErrorCode.CommentNotPermitted));
        });
      }
    ...
    if (schema) {
      ...
      return this.jsonSchemaService.resolveSchemaContent(new _jsonSchemaService.UnresolvedSchema(schema), id, {}).then(function (resolvedSchema) {
...
function schemaAllowsTrailingCommas(schemaRef) {
  if (schemaRef && typeof schemaRef === 'object') {
    ...
    if ((0, _objects.isBoolean)(schemaRef['allowsTrailingCommas'])) {
      // deprecated
...
},{"./jsonSchemaService.js":"node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/services/jsonSchemaService.js","../jsonLanguageTypes.js":"node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/jsonLanguageTypes.js","./../../../fillers/vscode-nls.js":"node_modules/monaco-editor/esm/vs/language/json/fillers/vscode-nls.js","../utils/objects.js":"node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/utils/objects.js"}],"node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/utils/colors.js":[function(require,module,exports) {
"use strict";
        ...
        node.properties.forEach(function (property) {
          ...
          if (valueNode) {
            if (limit > 0) {
              ...
              var location = _jsonLanguageTypes.Location.create(document.uri, getRange(document, property));
...
},{"./../../../fillers/vscode-nls.js":"node_modules/monaco-editor/esm/vs/language/json/fillers/vscode-nls.js"}],"node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/services/jsonFolding.js":[function(require,module,exports) {
"use strict";
...
var _main = require("./../../jsonc-parser/main.js");
...
function getFoldingRanges(document, context) {
  ...
  var stack = [];
  var prevStart = -1;
  var scanner = (0, _main.createScanner)(document.getText(), false);
  var token = scanner.scan();
      ...
      :
        {
          ...
          && startLine + 1 < document.lineCount) {
            scanner.setPosition(document.offsetAt(_jsonLanguageTypes.Position.create(startLine + 1, 0)));
          } else {
...
function getSelectionRanges(document, positions, doc) {
  ...
  var scanner = (0, _main.createScanner)(document.getText(), true);
...
var _jsonSelectionRanges = require("./services/jsonSelectionRanges.js");
...
},{"./_deps/vscode-json-languageservice/jsonLanguageService.js":"node_modules/monaco-editor/esm/vs/language/json/_deps/vscode-json-languageservice/jsonLanguageService.js"}],"node_modules/monaco-editor/esm/vs/language/json/tokenization.js":[function(require,module,exports) {
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
exports.TOKEN_DELIM_OBJECT = TOKEN_DELIM_OBJECT;
var TOKEN_DELIM_ARRAY = 'delimiter.array.json';
exports.TOKEN_DELIM_ARRAY = TOKEN_DELIM_ARRAY;
var TOKEN_DELIM_COLON = 'delimiter.colon.json';
exports.TOKEN_DELIM_COLON = TOKEN_DELIM_COLON;
var TOKEN_DELIM_COMMA = 'delimiter.comma.json';
exports.TOKEN_DELIM_COMMA = TOKEN_DELIM_COMMA;
var TOKEN_VALUE_BOOLEAN = 'keyword.json';
exports.TOKEN_VALUE_BOOLEAN = TOKEN_VALUE_BOOLEAN;
var TOKEN_VALUE_NULL = 'keyword.json';
exports.TOKEN_VALUE_NULL = TOKEN_VALUE_NULL;
var TOKEN_VALUE_STRING = 'string.value.json';
exports.TOKEN_VALUE_STRING = TOKEN_VALUE_STRING;
var TOKEN_VALUE_NUMBER = 'number.json';
exports.TOKEN_VALUE_NUMBER = TOKEN_VALUE_NUMBER;
var TOKEN_PROPERTY_NAME = 'string.key.json';
exports.TOKEN_PROPERTY_NAME = TOKEN_PROPERTY_NAME;
...
function setupMode(defaults) {
  ...
  function registerProviders() {
    ...
    if (modeConfiguration.tokens) {
      providers.push(monaco.languages.setTokensProvider(languageId, (0, _tokenization.createTokenizationSupport)(true)));
    }
...
//# sourceMappingURL=/jsonMode.07ea2b66.js.map